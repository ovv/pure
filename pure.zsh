...
prompt_pure_preprompt_render() {
	...
	# Execution time.
	[[ -n $prompt_pure_cmd_exec_time ]] && preprompt_parts+=('%F{242}${prompt_pure_cmd_exec_time}%f')
...
prompt_pure_setup() {
	...
	# if a virtualenv is activated, display it in yellow
	PROMPT='%(12V.%F{magenta}%12v%f .)'
